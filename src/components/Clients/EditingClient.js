            ...
            <form className="col-sm-offset-2 form-horizontal">
                <div className="form-group">
                    ...
                    <div className="col-sm-4">
                        <input type="email" className="form-control" id="inputEmail3" placeholder="Имя" value={editingClientData.firstName} />
                    </div>
                </div>
                <div className="form-group">
                    <label for="inputEmail3" className="col-sm-2 control-label">Фамилия</label>
                    <div className="col-sm-4">
                        <input type="email" className="form-control" id="inputEmail3" placeholder="Фамилия"/>
                    </div>
                </div>
                <div className="form-group">
                    <label for="inputEmail3" className="col-sm-2 control-label">Отчество</label>
                    <div className="col-sm-4">
                        <input type="email" className="form-control" id="inputEmail3" placeholder="Отчество"/>
                    </div>
                </div>
                <div className="form-group">
