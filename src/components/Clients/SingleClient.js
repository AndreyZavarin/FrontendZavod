        ...
        return <div>
            <div className="col-sm-12" style={{background: '#ffffff'}}>
                <ul className="breadcrumb" style={{background: '#fff', fontSize: '16px'}}>
                    ...
                    <li className="active"><span className="glyphicon glyphicon-user"></span> Информация о клиенте</li>
                </ul>
            </div>
            ...
            <form className="col-sm-offset-2 form-horizontal" style={{marginTop: '5%'}}>
                <div className="form-group">
                    <label for="inputEmail3" className="col-sm-2 control-label" >№ абонемента</label>
                ...
                <div className="form-group" style={{marginTop: '80px'}}>
                    <div className="col-sm-offset-2 col-sm-10">
                        <button onClick={this.props.updateActivePage.bind(this, 'editingClient')} type="submit" className="btn btn-success" >Редактировать</button>
                    </div>
                </div>
            </form>
            </div>
